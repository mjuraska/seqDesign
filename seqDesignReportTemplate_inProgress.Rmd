...
```{r label=inputParameters, results='asis', echo=FALSE, warning=FALSE, message=FALSE}
rm(list=ls(all=TRUE))
...
if (Sys.getenv("USERNAME")=="mjuraska"){
  ...
  source("C:/Users/brian/OneDrive/Documents/R/source_seqDesign.R")  
}
...
tab <- data.frame(atEventCount, infFractionEff=paste0(infFractionEff, "\\%"), nominalAlphaEff, 
                  estVE=ifelse(grepl("NA", VEboundEff), "NA", paste0("$\\mathrm{VE} \\geq ", VEboundEff, "\\%$")),
                  estHR=ifelse(grepl("NA", HRboundEff), "NA", paste0("$\\mathrm{HR} \\leq ", HRboundEff, "$")),
...
print(xtable(tab,
      ...
      add.to.row=list(pos=list(0, NROW(tab)),
                      command=c(paste0("\\hline \\hline  
                                       ...
                                       \\cline{3-6}
                                       FAS-15d+ & Inf & Nominal & Est. VE & Est. HR & Cum Prob of Crossing \\\\\n
...
tab <- data.frame(atEventCountNonEff, infFractionNonEff=paste0(infFractionNonEff, "\\%"), nominalAlphaNonEff, 
                  estVE=ifelse(grepl("NA", VEboundNonEff), "NA", paste0("$\\mathrm{VE} \\leq ", VEboundNonEff, "\\%$")),
                  estHR=ifelse(grepl("NA", HRboundNonEff), "NA", paste0("$\\mathrm{HR} \\geq ", HRboundNonEff, "$")),
...
print(xtable(tab,
      ...
      add.to.row=list(pos=list(0, NROW(tab)),
                      command=c(paste0("\\hline \\hline  
                                       ...
                                       \\cline{3-6}
                                       PP-15d+ & Inf & Nominal & Est. VE & Est. HR & Cum Prob of Crossing \\\\\n
