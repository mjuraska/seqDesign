...
knitr::opts_chunk$set(echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE, fig.width=8, fig.asp=0.5, out.width='100%')
...
\item  `r atEventCount[length(atEventCount)]` primary endpoints occurring $\geq 15$ days after the first dose in the FAS cohort (henceforth referred to as the FAS-15d+ endpoints) is the target endpoint total for the event-driven primary analysis
\item  Efficacy monitoring at `r infFractionEff[1]`\%, `r infFractionEff[2]`\%, and `r infFractionEff[3]`\% of the target `r atEventCount[length(atEventCount)]` FAS-15d+ endpoints in the FAS cohort
\item  Non-efficacy monitoring at `r infFractionNonEff[1]`\%, `r infFractionNonEff[2]`\%, and `r infFractionNonEff[3]`\% of approximately `r atEventCountNonEff[length(atEventCountNonEff)]` endpoints occurring $\geq 15$ days after the second dose (henceforthh referred to as the PP-15d+ endpoints) in the PP cohort
\end{itemize}
\begin{itemize}
...
\item  `r format(0.5 * infRate * 100, digits=3, nsmall=3)`\% 6-month COV-DIS incidence rate in the placebo arm 
\end{itemize}
\begin{itemize}
...
\begin{itemize}
\item  Analyses performed when `r atEventCount[1]` (`r infFractionEff[1]`\% information fraction), `r atEventCount[2]` (`r infFractionEff[2]`\% information fraction), and `r atEventCount[length(atEventCount)]` FAS-15d+ endpoints have been accrued (`r atEventCount[length(atEventCount)]` is the target number for powering the trial for $\overline{VE}\textrm{(2--32)} = 60\%$)
\item  At the time of each analysis, testing of $H_0$ is performed in the FAS cohort including only FAS-15d+ endpoints
\item  Reject $H_0$ if the lower bound of the monitoring-adjusted 95\% Wald CI for VE is $> `r effNullVE * 100`\%$
...
\begin{itemize}
\item  Analyses performed when approximately `r atEventCountNonEff[1]` (`r infFractionNonEff[1]`\% information fraction), `r atEventCountNonEff[2]` (`r infFractionNonEff[2]`\% information fraction), and `r atEventCountNonEff[length(atEventCountNonEff)]` PP-15d+ endpoints have been accrued
...
\item  Reject $H_0$ if the upper bound of the nominal 95\% Wald CI for VE is $< `r nonEffNullVE * 100`\%$
...
Fraction & \multicolumn{3}{c}{(Rejecting $H_0$: $\mathrm{VE} \leq `r effNullVE * 100`\%$)}\\
\cline{2-4}
(FAS-15d+ & Nominal & Est. VE (Est. HR) & Cum Prob of Crossing\\
Endpoints) & Signif Level & at Bndary & Bndary if $\overline{VE}\textrm{(2--32)}=`r effDesignAltVE * 100`\%$\\
\hline
`r infFractionEff[1]`\% (`r atEventCount[1]`) & `r nominalAlphaEff[1]` & $\mathrm{VE} \geq `r VEboundEff[1]`\%$ & `r cumProbCrossEff[1]`\%\\
 & & $\mathrm{HR} \leq `r HRboundEff[1]`$ & \\
\hline
`r infFractionEff[2]`\% (`r atEventCount[2]`) & `r nominalAlphaEff[2]` & $\mathrm{VE} \geq `r VEboundEff[2]`\%$ & `r cumProbCrossEff[2]`\%\\
 & & $\mathrm{HR} \leq `r HRboundEff[2]`$ & \\
\hline
`r infFractionEff[3]`\% (`r atEventCount[3]`) & `r nominalAlphaEff[3]` & $\mathrm{VE} \geq `r VEboundEff[3]`\%$ & `r cumProbCrossEff[3]`\%\\
 & & $\mathrm{HR} \leq `r HRboundEff[3]`$ & \\
\hline \hline
\end{tabular}
\bigskip
...
Fraction & \multicolumn{3}{c}{(Rejecting $H_0$: $\mathrm{VE} \geq `r nonEffNullVE * 100`\%$)}\\
\cline{2-4}
(PP-15d+ & Nominal & Est. VE (Est. HR) & Cum Prob of Crossing\\
Endpoints) & Signif Level & at Bndary & Bndary if $\overline{VE}\textrm{(2--32)}=0\%$\\
\hline
`r infFractionNonEff[1]`\% (`r atEventCountNonEff[1]`) & `r nominalAlphaNonEff[1]` & $\mathrm{VE} \leq `r VEboundNonEff[1]`\%$ & `r cumProbCrossNonEff[1]`\%\\
 & & $\mathrm{HR} \geq `r HRboundNonEff[1]`$ & \\
\hline
`r infFractionNonEff[2]`\% (`r atEventCountNonEff[2]`) & `r nominalAlphaNonEff[2]` & $\mathrm{VE} \leq `r VEboundNonEff[2]`\%$ & `r cumProbCrossNonEff[2]`\%\\
 & & $\mathrm{HR} \geq `r HRboundNonEff[2]`$ & \\
\hline
`r infFractionNonEff[3]`\% (`r atEventCountNonEff[3]`) & `r nominalAlphaNonEff[3]` & $\mathrm{VE} \leq `r VEboundNonEff[3]`\%$ & `r cumProbCrossNonEff[3]`\%\\
 & & $\mathrm{HR} \geq `r HRboundNonEff[3]`$ & \\
\hline \hline
\end{tabular}
...
\begin{itemize}
\item  Starting at the 12$^{\textrm{th}}$ FAS-15d+ endpoint and then continuously (i.e., after each FAS-15d+ endpoint) until the first interim analysis for lack of benefit (at `r atEventCount[1]` FAS-15d+ endpoints)
...
\begin{figure}[H]
\begin{center}
```{r label=plotOutcomeProbs, results='asis', fig.width=10, fig.asp=0.7, out.width='95%'}
...
\begin{figure}[H]
\begin{center}
```{r label=plotUncPowerPP, fig.width=10, fig.asp=0.7, out.width='95%', eval=ifelse(file.exists(file.path(srcDir, paste0("VEpwPP_nPlac=",N.pla,"_nVacc=",N.vax,"_infRate=",format(infRate, digits=3, nsmall=3),".RData"))), TRUE, FALSE)}
...
\begin{figure}[H]
\begin{center}
```{r label=plotTimeToReportingPrimaryResult_v1, fig.width=10, fig.asp=0.7, out.width='95%', eval=ifelse(file.exists(file.path(srcDir, "decisionTimes.RData")), TRUE, FALSE)}
...
\begin{figure}[H]
\begin{center}
```{r label=plotTimeToReportingPrimaryResult_v2, fig.width=6, fig.asp=0.7, out.width='95%'}
# a list named 'decisionTimes'
...
\newpage
```{r label=tableEventSplitAndNominalCIAtVE, results='asis', eval=ifelse(file.exists(file.path(srcDir, "eventSplits.RData")), TRUE, FALSE)}
...
\begin{figure}[H]
\begin{center}
```{r label=plotDuration1VaxArmEvaluation, fig.width=10, fig.asp=0.7, out.width='95%'}
stage2 <- 108
...
```
\caption{Distribution of trial duration with 25 months of follow-up ($n=$`r format(N.pla, scientific=FALSE)` in the placebo arm and $n=$`r format(N.vax, scientific=FALSE)` in the vaccine arm)}
\end{center}
\end{figure}

```{r label=plotTrialDuration, results='asis', fig.width=10, fig.asp=0.7, out.width='95%'}
...
\newpage
```{r label=tableMITTfailureSplitAndCIAtVE, results='asis'}
...
\begin{comment}
\newpage
```{r label=tableNinfStage1, results='asis'}
aveVE <- c(0, 0.6)
...
```{r label=tableNoneffBoundary, results='asis'}
...
\newpage
```{r label=tabEventAccrual_atEvents_q0.5, results='asis', eval=FALSE}
aveVE <- 0.4
pMissVax <- 0.05
...
print(xtable(tableEventAccrual,
      ...
      add.to.row=list(pos=list(0, NROW(tableEventAccrual)),
                      command=c("\\hline \\hline Endpoint & Med Months* & Med Months* \\\\\n Total & MITT$^{\\dagger}$ & PP$^{\\ddag}$\\\\\n \\hline",
                                ...
                                \\multicolumn{3}{l}{\\footnotesize $^{\\ddag}$ Endpoints in the PP cohort starting} \\\\\n
                                \\multicolumn{3}{l}{\\footnotesize \\quad $\\geq 26$ weeks after enrollment}")), comment=FALSE)
```

\newpage
```{r label=tabEventAccrual_atEvents_q0.8, results='asis', eval=FALSE}
aveVE <- 0.4
pMissVax <- 0.05
prob=0.8
tableEventAccrual <- tabEventAccrual(file.path(srcDir, paste0("simTrial_nPlac=",N.pla,"_nVacc=",N.vax,"_aveVE=",aveVE,"_infRate=",infRate,".RData")),
...
print(xtable(tableEventAccrual,
      ...
      add.to.row=list(pos=list(0, NROW(tableEventAccrual)),
                      command=c(paste0("\\hline \\hline Endpoint & ", prob * 100, "$^{\\textrm{th}}$ \\%ile Months* & ", prob * 100, "$^{\\textrm{th}}$ \\%ile Months* \\\\\n Total & MITT$^{\\dagger}$ & PP$^{\\ddag}$\\\\\n \\hline"),
                                ...
                                \\multicolumn{3}{l}{\\footnotesize \\quad $>0$ weeks after enrollment} \\\\\n 
                                \\multicolumn{3}{l}{\\footnotesize $^{\\ddag}$ Endpoints in the PP cohort starting} \\\\\n
                                \\multicolumn{3}{l}{\\footnotesize \\quad $\\geq 26$ weeks after enrolment}"))), comment=FALSE)
```


\newpage
```{r label=tabEventAccrual_atWeeks_q0.5, results='asis', eval=FALSE}
aveVE <- 0.6
pMissVax <- 0.05
tableEventAccrual <- tabEventAccrual(file.path(srcDir, paste0("simTrial_nPlac=",N.pla,"_nVacc=",N.vax,"_aveVE=",aveVE,"_infRate=",infRate,".RData")),
...
print(xtable(tableEventAccrual,
      ...
      add.to.row=list(pos=list(0, NROW(tableEventAccrual)),
                      command=c("\\hline \\hline  & Med Endpoints & Med Endpoints \\\\\n Months* & MITT$^{\\dagger}$ & PP$^{\\ddag}$\\\\\n \\hline",
                                ...
                                \\multicolumn{3}{l}{\\footnotesize \\quad $>0$ weeks after enrollment} \\\\\n 
                                \\multicolumn{3}{l}{\\footnotesize $^{\\ddag}$ Median endpoints in the PP cohort starting} \\\\\n
                                \\multicolumn{3}{l}{\\footnotesize \\quad $>26$ weeks after enrollment}")), comment=FALSE
```


\newpage
```{r label=tabEventAccrual_atWeeks_q0.8, results='asis', eval=FALSE}
aveVE <- 0.6
pMissVax <- 0.05
prob <- 0.2
tableEventAccrual <- tabEventAccrual(file.path(srcDir, paste0("simTrial_nPlac=",N.pla,"_nVacc=",N.vax,"_aveVE=",aveVE,"_infRate=",infRate,".RData")),
...
```{r label=tableInfSplits, results='asis', eval=ifelse(file.exists(file.path(srcDir,paste0("monitorTrial_nPlac=",N.pla,"_nVacc=",N.vax,"_aveVE=0.2_infRate=",infRate,"_",estimand,".RData"))), TRUE, FALSE)}
...
\begin{figure}[H]
\begin{center}
```{r label=plotNonEffStopBounds, fig.width=5, fig.height=3.8, eval=ifelse(file.exists(file.path(srcDir,paste0("monitorTrial_nPlac=",N.pla,"_nVacc=",N.vax,"_aveVE=0.2_infRate=",infRate,"_",estimand,".RData"))), TRUE, FALSE)}
par(mar=c(5.5,5,1,1), las=1, cex.axis=1.1, cex.lab=1.2)
...
```{r label=tableNonEffInfSplits, results='asis'}
