...
for (i in 1:length(aveVElist)){
  ...
  monitorTrial(dataFile=
               ...
               estimand=estimand, laggedMonitoring=laggedMonitoring, lagTime=lagTime, saveDir=outDir)
